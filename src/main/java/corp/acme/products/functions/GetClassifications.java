...
public class GetClassifications implements Function<List<String>, List<corp.acme.common.domain.Classification>> {
    @Autowired
    ProductsService productsService;

    @Override
    public List<corp.acme.common.domain.Classification> apply(List<String> names) {
        return productsService.fetchClassifications(names);
    }
}
